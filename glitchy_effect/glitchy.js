...
var ascii = (function() {
  ...
  var meassureBrightness = char => {
    ...
    charCtx.font = '18px '+fontFamily; // font-size
    charCtx.fillStyle = 'mediumseagreen'; // font color
...
fileInput.addEventListener('change', function() {
  if (this.files && this.files[0]) {
    ...
    reader.onload = (e) => {
      ...
      var h = canvas.height = size/img.height;
      ctx.drawImage(img,0,0,w,h);
      document.body.appendChild(canvas);
      
      console.log(canvas.width,canvas.height, size, img.width, img.height)
      createGif(ctx.getImageData(0,0,500,500));
